...
def plot_3d(sw,scale='linear'):
    ...
    # legend (robust across Matplotlib versions)
    leg = ax.legend()
...
# --------------------------
# Compare halite saturated vapor composition of |xThermal| and :cite:`Driesner2007Part2`, and also compare result based on different EOS of water.
def benchmark_VL(sw,mmc4='../Driesner2007a/1-s2.0-S0016703707002943-mmc4.txt'):
    ...
    fpout.write('T[C],P[bar],XV(Driesner)[mol],XV(xThermal)[mol],XV(diff)[mol]\n')
