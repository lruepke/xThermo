...
# --------------------------
# Compare result of |xThermal| and :cite:`Driesner2007Part2`, and also compare result based on different EOS of water.
...
# -----------------------------
#
# Result data calculated by |xThermal| based on both water EOS of IAPS84 and IAPWS95.
#
# .. seealso::
#
...
# .. tab:: IAPS84
#
#     Comparison between result of :cite:`Driesner2007Part2` and result calculated by xThermal: :download:`mmc4_IAPS84.csv`
#
# .. tab:: IAPWS95
#
#     Comparison between result of :cite:`Driesner2007Part2` and result calculated by xThermal: :download:`mmc4_IAPWS95.csv`
#
#
# .. tip::
#
...
# .. warning::
#
#     The difference of :math:`X_l, X_v, \rho_l, \rho_v, H_l, H_v` between |xThermal| and |mmc4| are caused by the following possible reasons,
#
...
#
#     2. several points close to critical curve and critical point of H2O, the difference of :math:`X_l, X_v` are up to :math:`1-^{-4}` mole fraction. This difference of X will cause density and enthalpy difference up to (~10, ~300) kg/m3 and (~100, ~1E4) J/kg, respectively. There is no way to check details in :cite:`Driesner2007Part1`, but I compare result of |xThermal| with the matlab code used in :cite:`vehling2021brine`, they are the same. In addition, if use the :math:`X_l, X_v` values in |mmc4| to calculate the density and enthalpy, will get the same result. Therefore, for the points close to critical curve, all the difference are caused by X difference.
#
#     3. For the :math:`X_v` difference in the high temperature region, still don't know the reason. But result of |xThermal| and the matlab code are the same. This :math:`X_v` difference will cause :math:`H_v` difference up to :math:`10^4` J/kg.
#
...
#     .. code:: bash
#
#         T[C],P[bar],XV(Driesner)[mol],XV(xThermal)[mol],XV(diff)[mol],RhoV(Driesner)[kg/m3],RhoV(xThermal)
