...
def plot_prop(water, ax=None,name_prop='Viscosity',unit_prop='Pa s',H=[],p=[],cmap='GnBu'):
...
def plot_error(ax, XX,YY,ZZ, eosA, eosB,cmap='RdBu',unit='Pa s'):
