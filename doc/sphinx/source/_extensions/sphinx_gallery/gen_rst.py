...
def codestr2rst(codestr, lang='python', lineno=None):
    ...
    result = code_directive + indented_block
    # 使用代码隐藏-collapse功能:如果代码行数小于5则不使用collapse功能
    if(codestr.count('\n')>5):
        collapse_directive = ".. collapse:: Python code\n\n"
        result = collapse_directive + indent(code_directive + indented_block, ' '*4)
    return result
