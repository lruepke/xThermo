...
double freesteam_mu(SteamState S){
	...
	switch(S.region){
		case 1:
			// printf("steam.c:freesteam_mu, case 1 Debug info: %lf,  %lf, %lf\n",
			// 										freesteam_region1_v_pT(S.R1.p,S.R1.T),
			// 										1./freesteam_region1_v_pT(S.R1.p,S.R1.T),
			// 										S.R1.T);
            return freesteam_mu_rhoT(1./freesteam_region1_v_pT(S.R1.p,S.R1.T), S.R1.T);
		case 2:
			// printf("steam.c:freesteam_mu, case 2 Debug info: %lf,  %lf, %lf\n",
			// 											freesteam_region2_v_pT(S.R2.p,S.R2.T),
			// 											1./freesteam_region2_v_pT(S.R2.p,S.R2.T),
			// 											S.R1.T);
            return freesteam_mu_rhoT(1./freesteam_region2_v_pT(S.R2.p,S.R2.T), S.R2.T);
		case 3:
			// printf("steam.c:freesteam_mu, case 3 Debug info: %lf,  %lf\n",
			// 										S.R3.rho,
			// 										S.R3.T);
