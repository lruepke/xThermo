...
[**File List**](files.md) **>** [**H2O**](dir_22b94ec4f3699d3ab17d67318090f0eb.md) **>** [**test\_H2O.py**](test__H2O_8py.md)

[Go to the documentation of this file](test__H2O_8py.md)
...
def test_prop(water,name_prop='rho',T=None,p=None):
    ...
    for i in range(0,TT.shape[0]):
        for j in range(0,TT.shape[1]):
            props = water.UpdateState_TPX(TT[i][j], PP[i][j], 0.0)
            prop[i][j] = props.Rho
    # plot
