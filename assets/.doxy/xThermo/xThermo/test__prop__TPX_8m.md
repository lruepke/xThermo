...
[**FileList**](files.md) **>** [**H2ONaCl**](dir_0a7d68cdfa0215953309325142e4c674.md) **>** [**Matlab**](dir_a83d64805f95e67d3b37610e6eb407bf.md) **>** [**test\_prop\_TPX.m**](test__prop__TPX_8m.md)

[Go to the source code of this file](test__prop__TPX_8m_source.md)
...
|   | [**H**](#variable-h)   = `reshape(H, size(TT))`<br> |
|   | [**Mu**](#variable-mu)   = `reshape(Mu, size(TT))`<br> |
|  end | [**P**](#variable-p)   = `linspace(800,1000,100)\*1E5`<br> |
|   | [**PP**](#variable-pp)   = `TT\*0 + P0`<br> |
|   | [**Rho**](#variable-rho)   = `reshape(Rho, size(TT))`<br> |
|   | [**T**](#variable-t)   = `linspace(550,650,200)`<br> |
|  P | [**X**](#variable-x)   = `10.^linspace(-10,0,100)`<br> |
|   | [**XX**](#variable-xx)   = `TT\*0 + X0`<br> |
...
|   | [**contourf**](#function-contourf) (TT, PP, reshape(PROP.Reg, size(TT))) <br> |
|   | [**contourf**](#function-contourf) (TT, PP, reshape(PROP.Rho, size(TT))) <br> |
|   | [**contourf**](#function-contourf) (TT, PP, reshape(PROP.h, size(TT))) <br> |
|   | [**contourf**](#function-contourf) (TT, PP, reshape(PROP.mu\_l, size(TT))) <br> |
|   | [**contourf**](#function-contourf) (TT, PP, reshape(PROP.mu\_v, size(TT))) <br> |
|   | [**contourf**](#function-contourf) (TT, PP, props. phase) <br> |
|   | [**contourf**](#function-contourf) (TT, PP, (reshape(PROP.Reg, size(TT)) - props.phase)) <br> |
|   | [**contourf**](#function-contourf) (TT, PP, (reshape(PROP.Rho, size(TT)) - props.Rho)) <br> |
|   | [**contourf**](#function-contourf) (TT, PP, (reshape(PROP.h, size(TT)) - props.H)) <br> |
|   | [**contourf**](#function-contourf) (TT, PP, (reshape(PROP.mu\_l, size(TT)) - props.Mu\_l)) <br> |
|   | [**contourf**](#function-contourf) (TT, PP, (reshape(PROP.mu\_v, size(TT)) - props.Mu\_v)) <br> |
...
|  toc | [**subplot**](#function-subplot) (rows, cols, 6) <br> |
...
|   | [**test\_constX\_H2ONaCl**](#function-test_constx_h2onacl) (0. 1, 'IAPS84') <br> |
...
------------------------------
The documentation for this class was generated from the following file `Library/H2ONaCl/Matlab/test_prop_TPX.m`
