...
[**File List**](files.md) **>** [**benchmark\_test**](dir_c3298c2f310225057389213c5b89b78a.md) **>** [**compare\_matlabcode**](dir_c0af4561eefcccb3b947513fd062ac1d.md) **>** [**helpfunc.py**](helpfunc_8py.md)

[Go to the documentation of this file](helpfunc_8py.md)
...
def set_axis_diagram_3D(ax):
    ax.set_ylabel("Temperature ($^{\circ}$C)")
    ax.set_xlabel("Wt.% NaCl")
    ...
    ax.zaxis.set_major_locator(MultipleLocator(500))
    ax.zaxis.set_minor_locator(MultipleLocator(100))

    # 重新自定义坐标轴属性
    niceAxis(ax,fill_pane=False,label3D=True,fs_label=0.024,length_major=0.02,length_minor=0.01, scaled=False)
    # ax.legend()
