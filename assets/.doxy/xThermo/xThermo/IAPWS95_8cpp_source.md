...
[**File List**](files.md) **>** [**H2O**](dir_22b94ec4f3699d3ab17d67318090f0eb.md) **>** [**IAPWS95.cpp**](IAPWS95_8cpp.md)

[Go to the documentation of this file](IAPWS95_8cpp.md)
...
//            printf ("%5d [%.7f, %.7f] %.7f  [%.7f, %.7f]\n",iter, T_K, P, rho,x_lo,x_hi);
        ...
        int func_HP2RhoT(const gsl_vector * x, void *params, gsl_vector * f)
        {
            ...
            y0     = h/RT -1.0 - tau*(phio.t + iapws->phi_r_t(delta, tau)) - delta*iapws->phi_r_d(delta, tau);      
            y1     = p/(RT*rho) - 1.0 - delta * iapws->phi_r_d(delta, tau);                                         
            gsl_vector_set (f, 0, y0);
            gsl_vector_set (f, 1, y1);
